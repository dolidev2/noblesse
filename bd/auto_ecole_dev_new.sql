...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 10 fév. 2020 à 18:15
...
INSERT INTO `bordereau_csv` (`id_bord_csv`, `nom`, `prenom`, `dob`, `pob`, `agence`, `categorie`, `date_d`) VALUES
...
INSERT INTO `caisse` (`id_caisse`, `type`, `somme`, `desc`, `compte`, `mode`, `date`) VALUES
(1, 'entre', 2333, 'werrr', 'sofipe', 'ESPECE', '2020-02-04');
...
(1, 'SAWADOGO', 'SOULEYMANE FRANCOIS', '8765434', 'etudiante', 'Secteur 22', '1998-10-02', 'masculin', '2019-10-18', 'Koumassi', 'D', 125000, 'normal', 1),
(2, 'WENA', 'WIELFRIED', '08675423', 'Elève', 'Secteur 22', '2019-10-03', 'masculin', '2019-10-23', 'Koumassi', 'B', 125000, 'normal', 1);
...
INSERT INTO `programation` (`id_programation`, `nom`, `prenom`, `dob`, `pob`, `agence`, `categorie`, `examen`) VALUES
...
--
ALTER TABLE `caisse`
  MODIFY `id_caisse` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `dossier`
--
ALTER TABLE `dossier`
  MODIFY `id_dossier` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `examen_eleve`
  MODIFY `id_examen_eleve` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `program`
  MODIFY `id_program` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
