...
if(isset($_POST["search"]["value"]))
{
	...
	$query .= 'OR dor LIKE "%'.$_POST["search"]["value"].'%" ';
...
foreach($result as $row)
{
	...
	<button type="button" title="Reinscrire"  name="examen" id="'.$row["id_eleve"].'" class="btn btn-success inscription_eleve "><i class="glyphicon glyphicon-ok"></i></button>
...
$output = array(
	...
	"recordsFiltered"	=>	Eleve::get_total_all_records_reinscrire(),
	"data"				=>	$data
);
